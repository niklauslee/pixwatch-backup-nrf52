...
#define DUK_OPT_NO_TRACEBACKS
#define DUK_OPT_NO_VERBOSE_ERRORS
#define DUK_OPT_NO_PC2LINE
#define DUK_OPT_NO_REGEXP_SUPPORT
#define DUK_OPT_NO_BYTECODE_DUMP_SUPPORT
#define DUK_OPT_NO_REFERENCE_COUNTING
#define DUK_OPT_LIGHTFUNC_BUILTINS
